...
func fillLivecommentResponse(ctx context.Context, dbConn *sqlx.DB, livecommentModel LivecommentModel) (Livecomment, error) {
	...
	commentOwner, err := fillUserResponse(ctx, dbConn, commentOwnerModel)
	if err != nil {
		return Livecomment{}, err
	}
